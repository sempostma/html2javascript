...
const nameManglingConfig = require('./config');
...
exports.parse = (html, {
    ...
    const config = nameMangling ? nameManglingConfig : defaultConfig;
    funcName = funcName || '';
    ...
    if (div.childNodes.length > 1) {
        ...
        div.childNodes.forEach(node => res += parseRecursive(node, 'container'));
